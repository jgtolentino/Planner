.PHONY: help deps up down restart logs install-module seed test-contract test-live test-drift test-all record-fixtures clean status verify verify-idempotent shell psql rebuild
